...
<template>
  ...
  <section class="py-5 border-bottom"
           id="features">
    <div class="container px-5 my-5 text-left">
      <h1>Privacy Policy</h1>
      <p>At ACB123, accessible from www.acb123.ca, one of our main priorities is the privacy of our visitors. This
        Privacy Policy document contains types of information that is collected and recorded by ACB123 and how we use
        it.</p>
      ...
      <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
        to the information that they shared and/or collect in ACB123. This policy is not applicable to any information
      ...
      <p>If you contact us directly, we may receive additional information about you such as your name, email address,
        ...
        choose to provide.</p>
      <p>Trade data uploaded to ACB123 is stored locally in your browser. You may delete them anytime.</p>
      ...
      <p>ACB123 follows a standard procedure of using log files. These files log visitors when they visit websites. All
      ...
      <P>You may consult this list to find the Privacy Policy for each of the advertising partners of ACB123.</p>

      <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on ACB123, which are sent directly to users' browser.
      ...
      <p>Note that ACB123 has no access to or control over these cookies that are used by third-party advertisers.</p>

      <h2>Third Party Privacy Policies</h2>

      <p>ACB123's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
      ...
      <p>ACB123 does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
  ...
  <footer class="py-5 bg-dark">
    <div class="container px-5">
      <p class="m-0 text-center text-white">Copyright &copy; ACB123 2022</p>
    </div>
  </footer>
</template>
<style scoped>
